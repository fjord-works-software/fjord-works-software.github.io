	...
	<div class="mx-auto max-w-6xl px-6 py-12">
		<div class="mb-8 grid grid-cols-1 gap-8 md:grid-cols-3">
			...
			<div>
				...
				<a
					href="mailto:hello@fjordworkssoftware.com"
					class="block text-sm text-brand-muted transition-colors hover:text-brand-primary"
				>
					hello@fjordworkssoftware.com
				</a>
				<div class="mt-3 flex gap-3">
					<a
						href="https://github.com/fjordworkssoftware"
						target="_blank"
					...
					<a
						href="https://linkedin.com/company/fjord-works-software"
						target="_blank"
						rel="noopener noreferrer"
						aria-label="LinkedIn"
						class="text-brand-muted transition-colors hover:text-brand-primary"
